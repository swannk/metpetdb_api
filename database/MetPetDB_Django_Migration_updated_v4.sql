...
create sequence element_mineral_types_seq start 1;
alter table element_mineral_types add column id int;
alter table element_mineral_types add constraint element_mineral_types_unq unique(element_id, mineral_type_id);
update element_mineral_types set id=nextval('seq');
...
create sequence mineral_relationships_seq start 1;
alter table mineral_relationships add column id int;
alter table mineral_relationships add constraint mineral_relationships_unq unique(parent_mineral_id, child_mineral_id);
update mineral_relationships set id=nextval('mineral_relationships_seq');
...
create sequence oxide_mineral_types_seq start 1;
alter table oxide_mineral_types add column id int;
alter table oxide_mineral_types add constraint oxide_mineral_types_unq unique(oxide_id, mineral_type_id);
update oxide_mineral_types set id=nextval('oxide_mineral_types_seq');
