...
update element_mineral_types_dup set id=nextval('element_mineral_types_seq');
...
update mineral_relationships_dup set id=nextval('mineral_relationships_seq');
...
update oxide_mineral_types_dup set id=nextval('oxide_mineral_types_seq');
