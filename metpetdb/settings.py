...
DATABASES = {
    'default': {
        ...
        'NAME': 'mpdb_test',                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = '/home/sball/metpetdb-py/webservices/static/'
...
SECRET_KEY = 'evoauuq36@chpb@topek73=@0kx2*rvvnjq=bzknuougd0%^*d'
