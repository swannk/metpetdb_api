 ...
 */
edu.rpi.tw.sesf.s2s.widgets.WmsOpenLayersBbox = function(panel) {
    this.panel = panel;
...
edu.rpi.tw.sesf.s2s.widgets.WmsOpenLayersBbox.prototype.get = function()
{
	return this.div;
}

edu.rpi.tw.sesf.s2s.widgets.WmsOpenLayersBbox.prototype.config = function() {
	var lon = 0;
	var lat = 0;
	var zoom = 2;
	var map, layer;
