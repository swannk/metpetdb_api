 ...
 */
edu.rpi.tw.sesf.s2s.widgets.UnsortedFacetedSelect = function(panel) 
{
	this.panel = panel;
...
edu.rpi.tw.sesf.s2s.widgets.UnsortedFacetedSelect.prototype.updateState = function(clicked)
{
...
edu.rpi.tw.sesf.s2s.widgets.UnsortedFacetedSelect.prototype.getState = function()
{
	return this.state;
}

edu.rpi.tw.sesf.s2s.widgets.UnsortedFacetedSelect.prototype.setState = function(state)
{
	var self = this;
...
edu.rpi.tw.sesf.s2s.widgets.UnsortedFacetedSelect.prototype.get = function()
{
	return this.div;
}

edu.rpi.tw.sesf.s2s.widgets.UnsortedFacetedSelect.prototype.reset = function()
{
...
edu.rpi.tw.sesf.s2s.widgets.UnsortedFacetedSelect.prototype.update = function(data)
{
...
edu.rpi.tw.sesf.s2s.widgets.UnsortedFacetedSelect.autocompleteSource = function(term, callback)
{
    var t = term;
...
edu.rpi.tw.sesf.s2s.widgets.UnsortedFacetedSelect.autocompleteSelect = function(event, ui)
{
    var item = ui.item;
