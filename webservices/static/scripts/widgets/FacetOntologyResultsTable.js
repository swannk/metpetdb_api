...
edu.rpi.tw.sesf.s2s.widgets.FacetOntologyResultsTable.prototype.update = function(data)
{
	...
	var paging = (limit != null && offset != null && total != null) ?
		...
		"";
	var table = "<table><thead><tr><th>Info</th><th>Link</th>";
	for (var i = 0; i < headers.length; ++i) {
		if (headers[i] != "link" && headers[i] != "goal") table += "<th>" + headers[i] + "</th>";
	}
	table += "</tr></thead><tbody>"
	for (var i = 1; i < results.length; ++i) {
		table += "<tr><td><a target=\"_blank_\" href=\"" + results[i]["goal"] + "\"><img src=\"http://aquarius.tw.rpi.edu/s2s/2.0/ui/images/icon_info_gray.gif\" /></a></td><td><a target=\"_blank_\" href=\""+results[i]["link"]+"\">link</a></td>";
